...
// Code for this class copied from https://github.com/noxo/BMP085Logger/blob/master/src/org/noxo/bmp085logger/util/BMP085Device.java
...
public class BMP085Device {
    ...
    public BMP085Device() throws Exception {
        setup(false);
    }
